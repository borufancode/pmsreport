...
class ReportDashboard extends CI_Controller
{
	public function __construct()
	{
		...
		$dbbureau = $this->load->database('default', true);
...
//		$data['assetCounts']=$this->rm->getAssetCountSheetReport($id);
		...
		$this->load->view('template/link');
		$this->load->view('template/sidemenu');
		$this->load->view('report/asset_count_sheet_report_filter', $data);
		$this->load->view('template/footer');
	}
...
//		$data['assetCounts']=$this->rm->AssetCountSummarySheetReportFilter($id);
		...
		$this->load->view('template/link');
		$this->load->view('template/sidemenu');
		$this->load->view('report/asset_count_summary_sheet_report_filter', $data);
		$this->load->view('template/footer');
	}
...
//$data['years']=$this->rm->getYears();
		...
		$this->load->view('template/link');
		$this->load->view('template/sidemenu');
		$this->load->view('report/stock_taking_sheet_report_filter', $data);
		$this->load->view('template/footer');
	}
...
//		$data['assetCounts']=$this->rm->getAssetCountSheetReport($id);
		...
		$this->load->view('template/link');
		$this->load->view('template/sidemenu');
		$this->load->view('report/vehicle_summary_report_filter', $data);
		$this->load->view('template/footer');
	}
...
//		$data['assetCounts']=$this->rm->getAssetCountSheetReport($id);
		$this->load->view('template/link');
		$this->load->view('template/sidemenu');
		$this->load->view('report/asset_value_report_filter', $data);
		$this->load->view('template/footer');
	}
	...
	public function AssetValueSummaryReportFilter($id)
	{
		...
		$this->load->view('template/link');
		$this->load->view('template/sidemenu');
		$this->load->view('report/asset_value_summary_report_filter', $data);
		$this->load->view('template/footer');
	}
