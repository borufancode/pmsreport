			...
			<div class="container-fluid">
				<div class="row mb-2">
					...
					<div class="col-sm-6 text-right">
						<h1 class="m-0">Stock Taking Count Sheet </h1>
					</div><!-- /.col -->
				</div>
				<!-- /.row -->
						...
						<div class="col col-12">
							<div class="card-body">
								...
								$queryOfficeName = $this->db->select('*')
									...
									->get()->row();
								?>
								<form action="<?= base_url('all-stock-taking-sheet-report') ?>" method="get">
									<div class="row">
										<div class="col col-md-12">
											...
											<?php if ($offciceID == 3) { ?>
												...
												<div class="col col-md-12">
													...
													<select required name="office_name" id="office"
															class="form-control">

													</select>
												</div>
											<?php } else { ?>
												<input name="id" type="hidden" value="<?= $offciceID ?>" readonly
													   class="form-control">
												<input name="office" type="hidden" value="<?= $queryOfficeName->id ?>"
													   readonly class="form-control">
												<input name="office_name" type="text"
													   value="<?= $queryOfficeName->name ?>" readonly
													   class="form-control">
											<?php } ?>
										</div>
									...
									<select required class="form-control" name="store">
										...
										<?php foreach ($this->rm->getStore($queryOfficeName->office_id) as $store) { ?>
										...
										<div class="col col-md-6">
											...
											<select required class="form-control" name="asset_group" id="assetgroup_id">
												...
												<?php foreach ($this->rm->getGroup() as $assetgroup) { ?>
