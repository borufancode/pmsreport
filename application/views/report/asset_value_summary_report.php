...
//								$assetsubgroup = $this->input->get('asset_sub_group');
								...
								$officemmd=$this->db->select('name')->from('office')->where('office.id',$offciceID)->get()->row();


								?>
								<p>
									Maqaa Mana Hojii/Public body/Office_
									<b><u>
									<?php if($offciceID == 3){ 
										echo $officemmd->name; 
									} 
								...
								<p>Bara Baajataa/Fiscal year _<u><b><?php if($queryOfficeYearName == ""){echo ''; } else {echo  $queryOfficeYearName->name;} ?>_</b></u></p>
