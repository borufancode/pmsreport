			...
			<div class="container-fluid">
				<div class="row mb-2">
					...
					<div class="col-sm-6 text-right">
						<h1 class="m-0">Fixed Asset Summary Sheet Report</h1>
					</div><!-- /.col -->
				</div><!-- /.row -->
						...
						<div class="card-header">
							<center>
								<h3> Biiroo Maallaqa Oromiyaa/
									...
									Fixed Asset count Summary Sheet(FACS)</h3>
							</center>
						...
						<div class="col col-12">
							<div class="card-body">
								...
								$queryOfficeName = $this->db->select('*')
										...
										->get()->row();
								?>
								<form action="<?= base_url('all-asset-count-summary-sheet-report')?>" method="get">
